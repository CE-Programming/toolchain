...
AppVars are special types of variables that can be used to store arbitrary data, and are used by the CE toolchain to provide data storage beyond what can be compiled into a program.
...
The OS stores variables in either RAM or archive (also known as flash) memory.
