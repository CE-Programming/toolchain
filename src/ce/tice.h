...
#define lcd_CrsrCtrl             (*(uint8_t*)0xE30C00)
#define lcd_CrsrConfig           (*(uint8_t*)0xE30C04)
#define lcd_CrsrPalette0         (*(uint24_t*)0xE30C08)
#define lcd_CrsrPalette1         (*(uint24_t*)0xE30C0C)
#define lcd_CrsrXY               (*(uint32_t*)0xE30C10)
#define lcd_CrsrX                (*(uint16_t*)0xE30C10)
#define lcd_CrsrY                (*(uint16_t*)0xE30C12)
#define lcd_CrsrClip             (*(uint16_t*)0xE30C04)
#define lcd_CrsrClipX            (*(uint8_t*)0xE30C04)
#define lcd_CrsrClipY            (*(uint8_t*)0xE30C05)
#define lcd_CrsrEnableInt        (*(uint8_t*)0xE30C20)
#define lcd_CrsrIntAcknowledge   (*(volatile uint8_t*)0xE30C24)
#define lcd_CrsrIntStatus        (*(uint8_t*)0xE30C28)
#define lcd_CrsrIntStatusMasked  (*(uint8_t*)0xE30C2C)
