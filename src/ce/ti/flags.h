 ...
 * 
 * @param GROUP Flag group name
 * @param MEMBER Flag item name
 */
...
#define flags_trig                      0 /**< FLAGS: Trig-related */
#define flags_trig_degrees              2 /**< Bit set for degrees, reset for radians */
#define flags_kbd                       0 /**< FLAGS: Keyboard scan control */
#define flags_kbd_SCR                   3 /**< Scan Code Read */
#define flags_kbd_keyPress              4 /**< Set if a key press is in the key press buffer */
#define flags_done                      0 /**< FLAGS: "Done" */
#define flags_done_prgm                 5 /**< Show "Done" after program exits */
#define flags_edit                      1 /**< FLAGS: OS edit buffer */
#define flags_edit_open                 2 /**< Set if an edit buffer is open */
#define flags_flags_Ans                 1 /**< Ans variable flags */
#define flags_Ans_scroll                3 /**< Set if viewing Ans can scroll, must be reset to move cursor in edit buffer */
/**
 * FLAGS: System monitor.
...
#define flags_plot                      2 /**< FLAGS: Plot screen */
...
#define flags_grfMode                   2 /**< FLAGS: Graph mode */
...
#define flags_graph                     3 /**< FLAGS: Graph screen */
...
#define flags_grf                       4 /**< FLAGS: Graph screen format */
...
#define flags_grf_polar                 3 /**< Displayy polar coordinates */
...
#define flags_text                      5 /**< FLAGS: Text display */
...
#define flags_parser                    6 /**< FLAGS: Parser (for BASIC and equations).  No useful equates for C programs. */
#define flags_parser2                   7 /**< FLAGS: Parser */
#define flags_parser2_numOP1            0 /**< Signals a result in OP1 */
#define flags_newDispF                  8 /**< FLAGS: Derivative mode */
...
#define flags_apd                       8 /**< FLAGS: Automatic Power-Down */
...
#define flags_on                        9 /**< FLAGS: On key */
...
#define flags_stats                     9 /**< FLAGS: Statistics */
#define flags_stats_valid               6 /**< Reset to recompute stat vars */
#define flags_fmt                       0x0A /**< FLAGS: Numeric format */
...
#define flags_numMode                   0x0A /**< FLAGS: numMode */
#define flags_fmt_real                  5
#define flags_fmt_rect                  6
#define flags_fmt_polar                 7
#define flags_fmtOverride               0x0B /**< FLAGS: copy of fmtFlags with conversion override */
//#define flags_fmtEdit                   0x0C /**< FLAGS: Numeric editing flags */
//#define flags_fmtEdit_flag              0 /**< 1=format number for editing */
#define flags_cursor                    0x0C /**< FLAGS: Homescreen cursor */
...
#define flags_cmd                       0x0C /**< FLAGS: Command editor */
#define flags_cmd_virgin                5 /**< Nothing has been typed so far.  (This is TI's official name.) */
#define flags_cmd_exec                  6 /**< Need to execute a command */
#define flags_app                       0x0D /**< FLAGS: Application stuff */
...
#define flags_rcl                       0x0D /**< FLAGS: Recall queue */
#define flags_rcl_enableQueue           7 /**< Enable recall queue */
#define flags_seq                       0x0F /**< FLAGS: Sequential graph */
...
#define flags_prompt                    0x11 /**< FLAGS: Prompt line */
#define flags_prompt_edit               1 /**< Editing in prompt buffer */
#define flags_indic                     0x12 /**< FLAGS: Run indicator. */
...
#define flags_table                     0x13 /**< FLAGS: Graph table screen */
...
#define flags_trace                     0x18 /**< FLAGS: Trace */
#define flags_trace_expression          0 /**< set to hide expression while tracing */
#define flags_stats2                    0x1A /**< FLAGS: More stats */
#define flags_stats2_diagnostics        0 /**< 1 = stat diagnostics on */
#define flags_stats2_noDel              2 /**< 1 = don't delete stats */
//#define flags_apd2              0x1B /**< FLAGS: APD part 2 */
//#define flags_apd2_warmStartInt       6 /**< 1 = a warm start is occurning before the next interrupt */
#define flags_graph2                    0x1F /**< FLAGS: Graph screen */
#define flags_graph2_splitOverride      3 /**< 0 = force full screen with ParseInp, or something */
#define flags_asm1                      0x21 /**< FLAGS: Intentionally unused by TI, available for programs! */
#define flags_asm2                      0x22 /**< FLAGS: Intentionally unused by TI, available for programs! */
#define flags_archive                   0x24 /**< FLAGS: Archive stuff */
...
#define flags_selfTest                  0x24 /**< FLAGS: Self-test screen */
#define flags_selfTest_resetOnPowerOn   2 /**< 1 = Force RAM reset when APD disabled on next power on */
#define flags_lowercase                 0x24 /**< FLAGS: Enable lowercase flag */
#define flags_lowercase_enable          3 /**< Enable lowercase flag */
#define flags_context                   0x25 /**< FLAGS: Context vectors */
...
#define flags_xap0                      0x2E /**< FLAGS: External apps */
#define flags_xap0_mouse                0 /**< Used by mouse cursor routines */
#define flags_xap1                      0x2F /**< FLAGS: External apps */
#define flags_xap2                      0x30 /**< FLAGS: External apps */
#define flags_xap3                      0x31 /**< FLAGS: External apps */
...
/**
 * FLAGS: OS hooks, also scriptFlag, rclFlag2, backGroundLink
 * 
...
#define flags_plot3                     0x3C /**< FLAGS: Plot screen */
...
#define flags_keyboard                  0x3D /**< FLAGS: Originally TI-Keyboard accessory, probably now USB keyboards */
...
#define flags_extraHooks                0x3E /**< FLAGS: Even more hooks */
...
#define flags_clock                     0x3F /**< FLAGS: Clock */
...
#define flags_mathprint                 0x44 /**< FLAGS: MathPrint */
...
#define flags_putMap                    0x4A /**< FLAGS: putMap */
