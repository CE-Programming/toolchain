 ...
 * This function returns "true" when the test_* parameters intersect into the master_* region,
 * otherwise false. It can be used for collision detection between rectangles.
 */
