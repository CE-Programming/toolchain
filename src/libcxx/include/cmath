...
template<typename _Tp> inline constexpr
std::enable_if_t<std::is_integral_v<_Tp>, int>
...
std::enable_if_t<std::is_integral_v<_Tp> && std::is_integral_v<_Up>, bool>
...
template<typename _Tp> inline constexpr
std::enable_if_t<std::is_integral_v<_Tp>, double>
...
template<typename _Tp, typename _Up> inline constexpr
std::enable_if_t<std::is_integral_v<_Tp> && std::is_integral_v<_Up>, double>
...
std::enable_if_t<std::is_integral_v<_Tp> && std::is_integral_v<_Up> && std::is_integral_v<_Vp>, double>
...
template<typename _Tp> inline constexpr
std::enable_if_t<std::is_integral_v<_Tp>, long long>
...
template<typename _Tp> inline constexpr
std::enable_if_t<std::is_integral_v<_Tp>, long>
