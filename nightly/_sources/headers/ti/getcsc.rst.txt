...
You can use this header instead of the :code:`keypadc` library, and it is particularly suited to non-game programs.

The OS's interrupt handler manages the keyboard driver and caches a scancode when it detects a key press.
You can use this scancode directly without translating 2nd and alpha through the :code:`os_GetCSC` function.
