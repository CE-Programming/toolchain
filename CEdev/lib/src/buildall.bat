...
set RTL_STATIC_ASM_SRC=acos.asm atof.asm ceil.asm cos.asm fabs.asm

set RTL_LINKED_C_SRC=
set RTL_LINKED_ASM_SRC=acos.asm asin.asm atan.asm atan2.asm atof.asm ceil.asm cos.asm cosh.asm exp.asm fabs.asm floor.asm fmod.asm frexp.asm ldexp.asm log.asm log10.asm modf.asm pow.asm sin.asm sinh.asm sqrt.asm strtod.asm tan.asm tanh.asm ufltinfo.asm ufltrnd.asm
