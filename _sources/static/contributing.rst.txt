...
For information on how to fork a repository and create a PR using GitHub, see the `forking documentation <https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/fork-a-repo>`_.
...
It is usually easier to download a toolchain release that already contains the needed binaries for compiling/assembling if you are just making code modifications to the toolchain.
...
Make sure that the ``bin`` directory is reachable by the system's PATH environment variable.
...
The only required package is `mingw-w64-x86_64-toolchain <https://packages.msys2.org/groups/mingw-w64-x86_64-toolchain>`_.
