...
You can join us on the :code:`CE Programming` Discord server in the :code:`#ez80-dev` channel by clicking the invite button below if you have any questions along the way.
...
The toolchain works natively across all major operating systems and has been developed by a few people who enjoy the challenge.
If you are interested in contributing your expertise, check out the :ref:`contributing` page and visit the `GitHub repository <https://github.com/CE-Programming/toolchain>`_.
